...
namespace AddressBook.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult PasswordRecovery(string emailAddress)
        {
            if (emailAddress != null)
            {
                mailHelper.PasswordRecovery(emailAddress);
                ViewBag.Msg = "Пароль выслан на почту!";
            }
        ...
        //in account controller
        public ActionResult Confirm(string userLogin, string confirmString)
        {
            _userLogic.ConfirmRegistration(userLogin, confirmString);          
            return View();
        }
        ...
        public ActionResult ExternalLoginCallback(string returnUrl)
        {
            ...
            else
            {
                ...
                ViewBag.ReturnUrl = returnUrl;
                return View("ExternalLoginConfirmation", new RegisterExternalLoginModel { UserLogin = result.UserName, ExternalLoginData = loginData });
            }
        }
        ...
        private static string ErrorCodeToString(MembershipCreateStatus createStatus)
        {
            ...
            switch (createStatus)
            {
                case MembershipCreateStatus.DuplicateUserName:
                    return "User login already exists. Please enter a different user login.";

                case MembershipCreateStatus.DuplicateEmail:
                    return "A user login for that e-mail address already exists. Please enter a different e-mail address.";
